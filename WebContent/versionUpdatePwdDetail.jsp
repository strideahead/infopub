...
<title>Information Public System v5.0</title>
		<link rel="stylesheet"  type="text/css"  href="css/main.css;css/Front.css"/>
	<title><s:text name="Information Public System v5.0"></s:text></title>
    ...
    <link type="text/css" href="css/pageControl.css"  rel="stylesheet" />
</head>
<body>
<body>
    ...
    <div id="pnlApply">
        ...
        <tr>
            ...
            <td align="left">
                <input name="txt_soft_ver" type="text" id="txt_soft_ver" class="normal" style="width: 170px" />
            </td>
            <td align="left" width="100">
                <span id="lbl_hard_ver">硬件版本</span>
            </td>
            <td align="left">
                <input name="txt_hard_ver" type="text" id="txt_hard_ver" class="normal" style="width: 170px" />
            </td>
        </tr>
        <tr>
            <td align="left">
            ...
            <td colspan="3" align="left">
                ...
                <span id="lbl_memo_apply_value" class="readonly" style="display:inline-block;border-width:2px;border-style:Inset;width:620px;"></span>
            </td>
        </tr>
        <tr>
            <td align="left">
            ...
            <td align="left" nowrap>
                <input name="txt_request_user" type="text" value="刘海丰" maxlength="50" readonly="readonly" id="txt_request_user" class="readonly" request_user_id="78" check_user_id="78" style="width:170px;" />
            </td>
            <td align="left">
                <span id="lbl_request_time">申请时间</span>
            </td>
            <td align="left" nowrap>
                <input name="txt_request_time" type="text" value="2014-07-10 11:49:58" maxlength="50" readonly="readonly" id="txt_request_time" class="readonly" style="width:170px;" />
            </td>
        </tr>
        <tr>
            <td align="left">
            ...
            <td align="left" nowrap>
                <input name="txt_apply_no" type="text" value="6300" maxlength="50" readonly="readonly" id="txt_apply_no" class="readonly" style="width:170px;" />
            </td>
            <td align="left">
                <span id="lbl_password_state_apply">密码状态</span>
            </td>
            <td align="left" nowrap>
                <input name="txt_password_state_apply" type="text" value="已批准" maxlength="50" readonly="readonly" id="txt_password_state_apply" class="readonly" style="color:Green;width:170px;" />
            </td>
        </tr>
        <tr id="tr_password_apply">
			...
			<td align="left" nowrap="nowrap" colspan="3">
                <input name="txt_password_apply" type="text" value="74DBC0D6" maxlength="50" readonly="readonly" id="txt_password_apply" class="readonly" ondblclick="return OpenSmsWindow(this);" style="width:620px;" />
 			</td>
		</tr>
	
        <tr id="tr_check_split" valign="top">
		<td colspan="4"> <hr /></td>
		</tr>
	
                        <tr id="tr_check_memo">
							<td align="left">
                                <span id="lbl_check_memo">批准备注</span>
                            </td>
							<td colspan="3" align="left">
                                
                                <span id="lbl_check_memo_value" class="readonly" style="display:inline-block;border-width:2px;border-style:Inset;width:620px;"></span>
                            </td>
						</tr>
	
                        <tr id="tr_check_user_time">
							<td align="left">
                                <span id="lbl_check_user">批准人</span>
                            </td>
							<td align="left" nowrap="nowrap">
                                <input name="txt_check_user" type="text" value="刘海丰" maxlength="50" readonly="readonly" id="txt_check_user" class="readonly" style="width:170px;" />
                            </td>
							<td align="left">
                                <span id="lbl_check_time">批准时间</span>
                            </td>
							<td align="left" nowrap="nowrap">
                                <input name="txt_check_time" type="text" value="2014-07-10 11:51:19" maxlength="50" readonly="readonly" id="txt_check_time" class="readonly" style="width:170px;" />
                            </td>
						</tr>
